...
if (houses && houses.data && houses.data.points) {
  ...
  console.log('ASC:', ascLon.toFixed(4) + '° = ' + sign + ' ' + Math.floor(deg) + '°' + Math.floor((deg % 1) * 60) + "'");
...
const sign2 = signs[Math.floor(ascLon2 / 30) % 12];
const deg2 = ascLon2 % 30;
console.log('\n=== route.ts 公式结果 ===');
console.log('LST:', LST.toFixed(2) + '°');
console.log('ASC:', ascLon2.toFixed(4) + '° = ' + sign2 + ' ' + Math.floor(deg2) + '°' + Math.floor((deg2 % 1) * 60) + "'");
console.log('差距:', (ascLon2 - 87.72).toFixed(2) + '°');

// 比对 sweph 和 route.ts 公式
console.log('\n=== 对比 ===');
console.log('sweph vs route.ts 差距:', (ascLon - ascLon2).toFixed(2) + '°');
console.log('sweph vs 期望 差距:', (ascLon - 87.72).toFixed(2) + '°');
console.log('route.ts vs 期望 差距:', (ascLon2 - 87.72).toFixed(2) + '°');