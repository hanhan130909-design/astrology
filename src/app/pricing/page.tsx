...
const T: Record<string, any> = {
  ...
  en: {
    badge: "PRO", hero: "Unlock Your Full Birth Chart", heroSub: "Basic charting is free forever. Pay once, access for life — no subscriptions, no recurring fees.",
    free: "Basic", freePrice: "Free", freeDesc: "Free forever. No sign-up required.",
    freeFeats: ["Natal Chart Analysis", "BaZi Four Pillars", "Daily Horoscope", "Tarot Reading", "Transit Tracking", "Basic Community"],
    freeCta: "Start Free",
    single: "Single AI Reading", singlePrice: "$3.99", singleDesc: "One payment. One deep, personalized reading.", singleBadge: "🔥 Popular",
    singleFeats: ["🔮 AI-Powered Deep Reading", "📊 Full BaZi Chart Analysis", "💡 Personalized Life Insights", "📋 Save & Export Results"],
    singleCta: "Get Your Reading ($3.99)",
    compatibility: "Compatibility", compPrice: "$19.99", compDesc: "Pay once, unlock forever",
    compFeats: ["✅ All Basic Features", "Dual BaZi Synastry Analysis", "Ten Gods Pairing Insights", "Five Elements Balance Report", "Relationship Trend Forecast", "Downloadable PDF Report"],
    compCta: "Get Compatibility ($19.99)",
    fortune: "Fortune Book", fortunePrice: "$29.99", fortuneDesc: "Pay once, unlock forever", fortuneBadge: "Most Popular",
    fortuneFeats: ["✅ All Basic Features", "✅ Full Compatibility Report", "2026 Year of the Horse Forecast", "12 Monthly Breakdowns", "Luck Cycle Deep Dive", "AI Readings (30/month)", "Career, Wealth & Love Focus"],
    fortuneCta: "Get Fortune Book ($29.99)",
    fate: "Book of Fate", fatePrice: "$39.99", fateDesc: "Pay once, unlock forever",
    fateFeats: ["✅ All Basic Features", "✅ Full Compatibility Report", "✅ Complete Fortune Book", "Lifetime BaZi Deep Reading", "Unlimited AI Conversations", "10-Year Luck Cycle Analysis", "Five Elements Balance Plan", "Early Access to New Features"],
    fateCta: "Get Book of Fate ($39.99)",
    faqTitle: "FAQ",
    faqs: [
      { q: "How is one-time payment different from a subscription?", a: "You pay once and own it for life. No monthly bills, no auto-renewals, no surprises." },
      { q: "Can I upgrade my plan later?", a: "Absolutely. Already bought Compatibility ($19.99)? Upgrade to Fortune Book for just the $10 difference." },
      { q: "What payment methods do you accept?", a: "Credit card and Google Pay right now. More options are on the way." },
      { q: "Which AI model powers the readings?", a: "We run Groq's Llama 3.3 70B as our primary engine, with DeepSeek as backup — all trained on our professional BaZi knowledge base." },
      { q: "What if I'm not happy with my reading?", a: "We offer a 7-day money-back guarantee. Not satisfied? Request a full refund, no questions asked." },
    ],
  },
  id: {
