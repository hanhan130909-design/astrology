...
const T: Record<string, Record<string, string>> = {
  ...
  subtitle: { zh: "输入出生信息，查看四柱八字、大运流年", en: "Enter your birth details to reveal your Four Pillars & Luck Cycles", id: "Lihat BaZi", th: "ดูดวงปาจื่อ", vi: "Xem Bát Tự", ms: "Lihat BaZi", ja: "四柱八字を表示", ko: "사주팔자 확인" },
  ...
  gender: { zh: "性别", en: "Gender", id: "JK", th: "เพศ", vi: "GT", ms: "Jantina", ja: "性別", ko: "성별" },
  ...
  element: { zh: "五行", en: "Elements", id: "Elemen", th: "ธาตุ", vi: "Ngũ Hành", ms: "Unsur", ja: "五行", ko: "오행" },
  ...
  hiddenStem: { zh: "藏干", en: "Hidden Stems", id: "Tersembunyi", th: "ธาตุซ่อน", vi: "Tàng Can", ms: "Tersembunyi", ja: "蔵干", ko: "장간" },
  tenGod: { zh: "十神", en: "10 Gods", id: "10Dewa", th: "เทพสิบ", vi: "Thập Thần", ms: "10Dewa", ja: "十神", ko: "십신" },
  ...
  aiPlaceholder: { zh: "输入问题追问…", en: "Ask a follow-up…", id: "Tanya…", th: "ถาม…", vi: "Hỏi…", ms: "Tanya…", ja: "質問…", ko: "질문…" },
  backHome: { zh: "返回首页", en: "Home", id: "Kembali", th: "กลับ", vi: "Về", ms: "Kembali", ja: "戻る", ko: "홈" },
