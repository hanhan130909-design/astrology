...
const features = [
  { href:"/natal", icon:"🪐", pro:false, zh:"本命星盘分析", zhDesc:"完整行星落位、宫位、相位深度解读", en:"Natal Chart", enDesc:"Planetary positions, houses & aspects in full detail", id:"Bagan Lahir", idDesc:"Posisi planet, rumah, aspek lengkap", th:"แผนภูมิเกิด", thDesc:"ตำแหน่งดาว บ้าน ราศี มุมสัมพันธ์", vi:"Bản đồ sao", viDesc:"Vị trí hành tinh, nhà, góc chiếu", ms:"Carta Lahir", msDesc:"Kedudukan planet, rumah, aspek lengkap", ja:"出生図", jaDesc:"惑星位置、ハウス、アスペクト", ko:"출생 차트", koDesc:"행성 위치, 하우스, 각도 분석" },
  { href:"/ai-reading", icon:"🤖", pro:true, zh:"AI 智能解读", zhDesc:"大模型驱动的深度星盘分析报告", en:"AI Reading", enDesc:"AI-powered deep chart interpretation & report", id:"AI Reading", idDesc:"Analisis bagan mendalam dengan AI", th:"AI ดูดวง", thDesc:"วิเคราะห์ดวงด้วย AI", vi:"AI Giải mã", viDesc:"Phân tích chuyên sâu bằng AI", ms:"AI Bacaan", msDesc:"Analisis carta mendalam oleh AI", ja:"AI 星読み", jaDesc:"AIによる深層星図分析", ko:"AI 해석", koDesc:"AI 기반 심층 차트 분석" },
  { href:"/compatibility", icon:"💕", pro:false, zh:"星座配对", zhDesc:"深入分析两人关系的契合度", en:"Compatibility", enDesc:"Deep relationship compatibility analysis", id:"Kecocokan", idDesc:"Analisis kecocokan hubungan", th:"ความเข้ากัน", thDesc:"วิเคราะห์ความเข้ากันของคู่", vi:"Tương hợp", viDesc:"Phân tích độ hợp nhau", ms:"Keserasian", msDesc:"Analisis keserasian hubungan", ja:"相性診断", jaDesc:"二人の相性を深く分析", ko:"궁합 분석", koDesc:"두 사람의 궁합 심층 분석" },
  { href:"/horoscope", icon:"📅", pro:false, zh:"每日运势", zhDesc:"爱情、事业、财运多维度指引", en:"Daily Horoscope", enDesc:"Daily guidance for love, career & money", id:"Horoskop Harian", idDesc:"Panduan cinta, karier, keuangan", th:"ดูดวงรายวัน", thDesc:"คำแนะนำความรัก งาน การเงิน", vi:"Tử vi hàng ngày", viDesc:"Tình yêu, sự nghiệp, tài chính", ms:"Horoskop Harian", msDesc:"Panduan cinta, kerjaya, kewangan", ja:"デイリー運勢", jaDesc:"恋愛・仕事・金運の指針", ko:"일일 운세", koDesc:"사랑, 직업, 재정 가이드" },
  { href:"/transits", icon:"🔭", pro:false, zh:"行运追踪", zhDesc:"实时追踪行星换座与重要相位", en:"Transits", enDesc:"Real-time planetary transits & major aspects", id:"Transit", idDesc:"Pantau pergerakan planet real-time", th:"ดาวโคจร", thDesc:"ติดตามการเคลื่อนที่ของดาว", vi:"Quá cảnh", viDesc:"Theo dõi hành tinh di chuyển", ms:"Transit", msDesc:"Pantau pergerakan planet masa nyata", ja:"トランジット", jaDesc:"惑星移動と重要アスペクト", ko:"행성 이동", koDesc:"실시간 행성 이동 추적" },
  { href:"/yearly-horoscope", icon:"📊", pro:true, zh:"年度运势报告", zhDesc:"预知全年运势走向", en:"Yearly Report", enDesc:"Complete year-ahead forecast", id:"Laporan Tahunan", idDesc:"Ramalan setahun penuh", th:"รายงานรายปี", thDesc:"พยากรณ์ตลอดทั้งปี", vi:"Báo cáo năm", viDesc:"Dự báo cả năm", ms:"Laporan Tahunan", msDesc:"Ramalan sepanjang tahun", ja:"年間レポート", jaDesc:"年間の運勢予測", ko:"연간 리포트", koDesc:"1년 운세 예측" },
  { href:"/tarot", icon:"🃏", pro:false, zh:"塔罗占卜", zhDesc:"神秘塔罗牌指引人生方向", en:"Tarot", enDesc:"Mystical tarot card readings", id:"Tarot", idDesc:"Panduan mistis kartu tarot", th:"ไพ่ทาโรต์", thDesc:"ไพ่ทาโรต์นำทางชีวิต", vi:"Tarot", viDesc:"Bài tarot huyền bí", ms:"Tarot", msDesc:"Panduan mistik kad tarot", ja:"タロット", jaDesc:"神秘のタロットが導く", ko:"타로", koDesc:"신비한 타로 카드 안내" },
  { href:"/compare", icon:"⚖️", pro:false, zh:"星盘对比", zhDesc:"对比两个星盘，探索关系动态", en:"Compare Charts", enDesc:"Compare two birth charts side by side", id:"Bandingkan", idDesc:"Bandingkan dua bagan", th:"เปรียบเทียบ", thDesc:"เปรียบเทียบสองดวง", vi:"So sánh", viDesc:"So sánh hai bản đồ sao", ms:"Banding", msDesc:"Banding dua carta", ja:"比較", jaDesc:"二つの星図を比較", ko:"비교", koDesc:"두 차트 비교 분석" },
  { href:"/community", icon:"💬", pro:false, zh:"占星社区", zhDesc:"与占星爱好者交流讨论", en:"Community", enDesc:"Connect with fellow astrology lovers", id:"Komunitas", idDesc:"Diskusi dengan penggemar", th:"ชุมชน", thDesc:"พูดคุยกับผู้สนใจ", vi:"Cộng đồng", viDesc:"Thảo luận cùng người yêu thích", ms:"Komuniti", msDesc:"Bincang dengan peminat", ja:"コミュニティ", jaDesc:"占星好きと交流", ko:"커뮤니티", koDesc:"별자리 애호가와 소통" },
  { href:"/academy", icon:"📚", pro:false, zh:"占星学院", zhDesc:"系统学习占星学课程", en:"Academy", enDesc:"Structured courses to master astrology", id:"Akademi", idDesc:"Kursus astrologi sistematis", th:"โรงเรียน", thDesc:"เรียนโหราศาสตร์อย่างเป็นระบบ", vi:"Học viện", viDesc:"Khóa học chiêm tinh", ms:"Akademi", msDesc:"Kursus astrologi sistematik", ja:"アカデミー", jaDesc:"占星学を体系的に学ぶ", ko:"아카데미", koDesc:"체계적인 점성술 강좌" },
  { href:"/consultation", icon:"🎓", pro:true, zh:"大师咨询", zhDesc:"预约专业占星师一对一咨询", en:"Consultation", enDesc:"1-on-1 sessions with professional astrologers", id:"Konsultasi", idDesc:"Konsultasi 1-on-1 dengan ahli", th:"ปรึกษา", thDesc:"ปรึกษาผู้เชี่ยวชาญ", vi:"Tư vấn", viDesc:"Tư vấn 1-1 với chuyên gia", ms:"Konsultasi", msDesc:"Konsultasi 1-on-1 dengan pakar", ja:"相談", jaDesc:"占星師とのマンツーマン相談", ko:"상담", koDesc:"전문가 1:1 상담" },
];
...
const T: Record<string, Record<string, string>> = {
  ...
  en: { badge:"Professional Astronomy · AI-Powered", hero:"Discover Your Cosmic Blueprint", heroSub:"Real astronomical calculations meet cutting-edge AI — delivering deeply personal, professional astrology readings", cta:"Get Your Free Chart", learn:"Learn More", free:"Free Forever", real:"True Astronomy", lang:"Languages", features:"Core Features", featSub:"Professional-grade tools designed for beginners and seasoned astrologers alike", try:"Try Now", zodiac:"Explore the Zodiac", zodiacSub:"Select your sign for today's horoscope", testimonials:"Testimonials", testSub:"What our users are saying", cta2:"Ready to discover what the stars have in store?", ctaBtn:"Get Started", privacy:"Privacy", terms:"Terms", contact:"Contact" },
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
            {features.map((f) => (
              ...
              >
                ...
                <span className="text-xs text-gray-500 group-hover:text-[#171717] transition-colors">{t.try} →</span>
              </Link>
            ))}
          </div>
        </div>
      ...
      <section className="py-12 md:py-20 px-6">
        <div className="max-w-[1200px] mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
            {[
              { text:{zh:"AI解读太准了！完全命中了我最近的事业转折点。",en:"The AI reading was spot on! It perfectly captured my career turning point.",id:"Pembacaan AI sangat akurat! Tepat mengenai titik balik karier saya.",th:"การอ่าน AI แม่นมาก! ตรงกับจุดเปลี่ยนในอาชีพของฉันเลย",vi:"AI đọc chính xác! Hoàn toàn trúng điểm ngoặt sự nghiệp của tôi.",ms:"Bacaan AI sangat tepat! Tepat mengenai titik perubahan kerjaya saya.",ja:"AI解读が的中！キャリアの転機を完璧に捉えていた。",ko:"AI 해석이 정확했어요! 제 경력 전환점을 완벽히 맞췄어요."}, name:{zh:"林小姐",en:"Ms. Lin",id:"Lin",th:"คุณหลิน",vi:"Cô Lâm",ms:"Cik Lin",ja:"林さん",ko:"린"}, role:{zh:"产品经理",en:"Product Manager",id:"Manajer Produk",th:"ผู้จัดการผลิตภัณฑ์",vi:"Quản lý sản phẩm",ms:"Pengurus Produk",ja:"プロダクトマネージャー",ko:"제품 관리자"} },
              { text:{zh:"每日运势已经成为我每天必看的习惯。",en:"Daily horoscope has become my daily must-read habit.",id:"Horoskop harian sudah jadi kebiasaan wajib saya setiap hari.",th:"ดูดวงรายวันกลายเป็นนิสัยที่ต้องอ่านทุกวันของฉัน",vi:"Tử vi hàng ngày đã trở thành thói quen không thể thiếu của tôi.",ms:"Horoskop harian sudah menjadi tabiat wajib saya setiap hari.",ja:"デイリー運勢は毎日の習慣になりました。",ko:"일일 운세는 매일 꼭 보는 습관이 되었어요."}, name:{zh:"陈先生",en:"Mr. Chen",id:"Chen",th:"คุณเฉิน",vi:"Anh Trần",ms:"Encik Chen",ja:"陳さん",ko:"첸"}, role:{zh:"创业者",en:"Entrepreneur",id:"Pengusaha",th:"ผู้ประกอบการ",vi:"Doanh nhân",ms:"Usahawan",ja:"起業家",ko:"창업가"} },
              { text:{zh:"作为专业人士，我也很认可这里的占星内容。",en:"As a professional, I also highly endorse the astrology content here.",id:"Sebagai profesional, saya juga sangat mengakui konten astrologi di sini.",th:"ในฐานะมืออาชีพ ฉันก็ยอมรับเนื้อหาโหราศาสตร์ที่นี่",vi:"Là chuyên gia, tôi cũng đánh giá cao nội dung chiêm tinh ở đây.",ms:"Sebagai profesional, saya juga sangat mengiktiraf kandungan astrologi di sini.",ja:"専門家としても、ここの占星コンテンツを高く評価しています。",ko:"전문가로서 여기 점성술 콘텐츠를 높이 평가합니다."}, name:{zh:"王女士",en:"Ms. Wang",id:"Wang",th:"คุณหวัง",vi:"Cô Vương",ms:"Cik Wang",ja:"王さん",ko:"왕"}, role:{zh:"心理咨询师",en:"Psychologist",id:"Psikolog",th:"นักจิตวิทยา",vi:"Nhà tâm lý",ms:"Ahli Psikologi",ja:"心理カウンセラー",ko:"심리상담사"} },
            ].map((t, i) => (
              <div key={i} className="bg-gray-50 rounded-lg p-6">
                <p className="text-sm text-gray-600 leading-relaxed mb-4">&ldquo;{(t.text as any)[language] || t.text.zh}&rdquo;</p>
                <div className="text-[13px] font-semibold">{(t.name as any)[language] || t.name.zh}</div>
                <div className="text-xs text-gray-400">{(t.role as any)[language] || t.role.zh}</div>
              </div>
            ))}
          </div>
        </div>
