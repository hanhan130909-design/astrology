# Writes AuthContext.tsx with Firebase integration
import sys

content = '''// Firebase Auth Context - Real Firebase Authentication
...
with open(r"C:\Users\user\.qclaw\astrology-clean\src\contexts\AuthContext.tsx", "w", encoding="utf-8") as f:
    f.write(content)

print("AuthContext.tsx written successfully")